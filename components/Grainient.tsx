...
const Grainient: React.FC<GrainientProps> = ({
  ...
  useEffect(() => {
    ...
    // Start at a random time offset to vary the look on refresh
  ...
  useEffect(() => {
    ...
    const c1 = uniforms.uColor1.value as Float32Array;
    const rgb1 = hexToRgb(color1);
    c1[0] = rgb1[0]; c1[1] = rgb1[1]; c1[2] = rgb1[2];

    const c2 = uniforms.uColor2.value as Float32Array;
    const rgb2 = hexToRgb(color2);
    c2[0] = rgb2[0]; c2[1] = rgb2[1]; c2[2] = rgb2[2];

    const c3 = uniforms.uColor3.value as Float32Array;
